package com.as.demo_ok46.custom;
...
public class CardScaleHelper {
    ...
    private void onScrolledChangedCallback() {
        ...
        if (ichangelistener != null & mCurrentItemPos != lastPositon) {

            ichangelistener.itemChanged(mCurrentItemPos);
            lastPositon = mCurrentItemPos;
        }
    }
    ...
    public Ichangelistener ichangelistener;
